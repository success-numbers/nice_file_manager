...
@Component
public class OrderCustomerReturnScheduler {
    private static final Logger logger = LoggerFactory.getLogger(OrderCustomerReturnScheduler.class);
    ...
    @Value("${toRms.orders.order_customer_returns.S3_PARENT_DIR}")
    private String s3ParentDirectory;

    @Value("${toRms.orders.order_customer_returns.S3_DATA_DIR}")
    private String s3DataDirectory;

    @Value("${toRms.orders.order_customer_returns.S3_PROCESSED_DIR}")
    private String s3ProcessedDirectory;

    @Value("${toRms.orders.order_customer_returns.FTP_PARENT_DIR}")
